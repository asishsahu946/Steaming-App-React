...
const options = {
  ...
  return (
    <div className='text-white px-20 xl-max:px-10 sm-max:px-3 mt-16 mb-14'>
      <div className='border border-black5 rounded-2xl'>

      <h2 className="inline font-bold text-xl md-max:text-lg mb-2 relative bottom-4 left-9 rounded-lg px-3 py-2 bg-red1">Top Rated</h2>
      <Carousel
